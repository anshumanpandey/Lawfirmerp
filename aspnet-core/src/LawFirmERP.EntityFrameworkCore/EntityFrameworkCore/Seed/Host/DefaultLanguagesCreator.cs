...
namespace LawFirmERP.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly LawFirmERPDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = LawFirmERPConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LawFirmERPDbContext context)
        {
            _context = context;
        }
